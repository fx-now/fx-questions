...
CREATE USER 'fxnow'@'%' IDENTIFIED BY '***';GRANT USAGE ON *.* TO 'fxnow'@'%' IDENTIFIED BY '***' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `odin`.* TO 'fxnow'@'%'; 
...
INSERT INTO `odin`.`usuarios` (`id`, `nome`, `usuario`, `senha`, `nivel`) VALUES (NULL, 'FX Now', 'fxnow', 'fa38f3103751a64c615d9eb5c1b662fe7d90d6dd2694a21e5efdad3090bc3a1e7d9976f3c9a5f94bc9f1e75920d841b4ffb9f9ab9e6043a41db50117abdebbf0', '1'); 
